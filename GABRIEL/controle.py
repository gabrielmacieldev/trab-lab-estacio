...
dados_conexao = (
    "Driver={SQL Server};"
    "Server=DESKTOP-9KN48FH;"
    "Database=ExtensaoWork;"
)
...
def gerar_pdf():
    ...
    dados_lidos = cursor.fetchall()
    y = 0
    pdf = canvas.Canvas("PythonSql.pdf")
...
def funcao_principal():
    ...
    if formulario.radioButton.isChecked() :
        ...
        print("Categoria Automação selecionada")
    ...
    dados = [
        (str(linha1), str(linha2), str(linha3), categoria),
